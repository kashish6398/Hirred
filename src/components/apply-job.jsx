...
const schema = z.object({ 
    ...
    education: z.enum(["Intermediate","Graduate","Post Graduate"], {required_error: "Education is required"}),
    resume: z 
    .any()
    .refine(
        (file) => 
  ...
  <DrawerContent>
    <DrawerHeader>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-4 p-4 pb-0">
        ...
        {errorApply?.message && <p className="text-sm text-red-500">{errorApply?.message}</p>}
